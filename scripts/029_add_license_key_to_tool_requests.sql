...
-- This fixes the "null value in column license_key violates not-null constraint" error
...
COMMENT ON COLUMN tool_requests.license_key IS 'License key for the tool (if applicable)';

-- Update the create_tool_request function to include license_key
...
BEGIN
    ...
    INSERT INTO tool_requests (
        ...
        purchase_type, created_at, requested_at, ultra_id, password, license_key
    ) VALUES (
        ...
        NOW(), NOW(), '', p_password, p_license_key
