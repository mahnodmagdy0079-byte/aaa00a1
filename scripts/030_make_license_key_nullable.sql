-- Make license_key column nullable in tool_requests table
-- This allows purchases with credits without requiring a license key
...
-- Update the create_tool_request function to make license_key optional
