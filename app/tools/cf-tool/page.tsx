...
export default function CFToolPage() {
  const { language, setLanguage } = useLanguage()

  const content = {
    ar: {
      title: "CF TOOL",
      subtitle: "أداة الفلاشة والإصلاح",
      ...
      faq: {
        ...
        items: [
          { q: "هل تدعم الفلاشة لكل الموديلات؟", a: "تدعم أغلب الموديلات الشائعة ويتم التحديث باستمرار." },
          { q: "مدة الوصول؟", a: "24 ساعة من التفعيل." },
          { q: "هل أحتاج كريدت؟", a: "لا، الدفع من محفظة Tooly GSM فقط." },
          { q: "حلول الفشل؟", a: "نراجع الحالات المتأثرة بتعطل مزود الأداة يدوياً." }
        ]
      }
    },
    en: {
      title: "CF TOOL",
      subtitle: "Flashing and Repair Tool",
      ...
      features: {
        title: "Key Features",
        list: [
          "Advanced mobile device flashing",
          "System issue repair",
          "Firmware updates",
          "Malware removal",
      ...
      howItWorks: {
        ...
        steps: [
          ...
          "Choose CF TOOL from the tools list",
      ...
      faq: {
        title: "FAQs",
        items: [
          { q: "Flashing coverage?", a: "Supports most common models with continuous updates." },
          { q: "Access duration?", a: "24 hours from activation." },
          { q: "Need credits?", a: "No, wallet-based payment only." },
          { q: "Failure handling?", a: "Vendor outage cases are reviewed manually." }
        ]
      }
    }
  }
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/CF-Tool-logo-4fWDOa32L480YscXSWQ4PTGDTpmUWy.png",
            description: "وصول CF Tool لمدة 24 ساعة عبر أتمتة Tooly GSM بسعر 70 جنيه.",
            offers: {
              "@type": "Offer",
              priceCurrency: "EGP",
              price: "70",
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-32 h-32 rounded-2xl bg-gray-800 p-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/CF-Tool-logo-4fWDOa32L480YscXSWQ4PTGDTpmUWy.png"
                alt="CF TOOL"
                width={128}
                height={128}
