...
export default function TFMToolPage() {
  const { language, setLanguage } = useLanguage()

  const content = {
    ar: {
      title: "TFM TOOL",
      subtitle: "أداة إدارة الملفات التقنية",
      ...
      howItWorks: {
        ...
        steps: [
          ...
          "اختر TFM TOOL من قائمة الأدوات",
      ...
      faq: {
        ...
        items: [
          { q: "ما هو استخدام TFM؟", a: "لإدارة الملفات التقنية وإصلاحات متعددة على النظام." },
          { q: "مدة الوصول؟", a: "24 ساعة من التفعيل." },
          { q: "هل يتطلب كريدت؟", a: "لا، محفظة Tooly GSM فقط." },
          { q: "الدعم؟", a: "التذاكر متاحة عبر لوحة التحكم." }
        ]
      }
    },
    en: {
      title: "TFM TOOL",
      subtitle: "Technical File Management Tool",
      ...
      howItWorks: {
        ...
        steps: [
          ...
          "Choose TFM TOOL from the tools list",
      ...
      faq: {
        title: "FAQs",
        items: [
          { q: "What is TFM for?", a: "Technical file management and various system fixes." },
          { q: "Access duration?", a: "24 hours from activation." },
          { q: "Need credits?", a: "No, wallet-only payments." },
          { q: "Support?", a: "Tickets available via dashboard." }
        ]
      }
    }
  }
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "وصول TFM Tool لمدة 24 ساعة عبر أتمتة Tooly GSM بسعر 50 جنيه.",
            offers: {
              "@type": "Offer",
              priceCurrency: "EGP",
              price: "50",
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-32 h-32 rounded-2xl bg-gray-800 p-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/TFM-TOOL-xOkieC4R23uDNcaBCD4ZThBl1iixQY.png"
                alt="TFM TOOL"
                width={128}
                height={128}
